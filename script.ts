...
const items: itemsInterface[] = [
    ...
    {
        name: "Screen",
        photo: "https://lh3.googleusercontent.com/proxy/Lm3LzOOZbkyDc5Qha7SsskN0iVpfI_bKTzYMn-uNqkEQby3vduZ2NyH7LTQI9tGrmqGJRkOfX5KsKzZ0T0YGcnZ2y9NVj4nLwc1sRGpG-AXj2Y_-i5mC6ZSRzUI",
        weight: 8,
        price: 150,
        category: "electronics"
    },
...
let productContainer = document.querySelector(`.product-container`) as HTMLElement

for (const item of items) {
    let productCard = document.createElement("div") as HTMLElement
